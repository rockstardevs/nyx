...
var (
	...
	// queue watcher flags
	queueDir     = flag.String("queue_dir", "", "a path to watch for new files to process.")
	queuePattern = flag.String("queue_re", `\.(pdf|qif|ofx|qfx)$`, "a regexp pattern to match files to process in queue_dir.")
)
